# gs-skill-matrix-frontend

Front-end app for skill matrix
...
### Hierarchy
- __app__: gs-skill-matrix-frontend root system (component).
...
```bash
{TIMESTAMP} | {LOG_LEVEL} [{gs-skill-matrix-frontend}] | {MESSAGE}
```
